  ...
  function obtenerYAgregarRegistros2() {
      ...
      fetch(url)
          ...
          .then((data) => {
              ...
              agregarRegistros("Almendros-registros", registrosHoy.filter((registro) => registro.domicilio.startsWith("IkFsbWV")));
              agregarRegistros("Bugambilias-registros", registrosHoy.filter((registro) => registro.domicilio.startsWith("IkJ1Z2F")));
              agregarRegistros("Laureles-registros", registrosHoy.filter((registro) => registro.domicilio.startsWith("IkxhdXJ")));
              agregarRegistros("Magnolias-registros", registrosHoy.filter((registro) => registro.domicilio.startsWith("Ik1hZ25")));
              agregarRegistros("Tulipanes-registros", registrosHoy.filter((registro) => registro.domicilio.startsWith("IlR1bGl")));
              agregarRegistros("Violetas-registros", registrosHoy.filter((registro) => registro.domicilio.startsWith("IlZpb2x")));
          })
          .catch((error) => {
              console.error(error);
          });
